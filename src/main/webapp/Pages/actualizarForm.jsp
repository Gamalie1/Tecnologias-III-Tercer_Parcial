        ...
        <div class="containerForm">
            <div class="row card hoverable">
                <div class="card-content ">
                    ...
                    <form class="row s12" action="UsuarioServletController?action=actualizar" method="post">
                        <input type='hidden' name='id' value="<c:out value="${usuario.id}"></c:out>" ><br>  
                            <div class="col s12">
                                <div class="input-field">
                                    <input type="text" name="nombreusuario" placeholder="Nombre de ususario*" value="<c:out value="${usuario.nombreusuario}" ></c:out>">
                                </div>
                            </div>
                            <div class="col s12">
                                <div class="input-field">
                                    <input type="password" name="contrasena" placeholder="Contraseña*" value="<c:out value="${usuario.contrasena}"></c:out>">
                                </div>
                            </div>
                            <div class="col s12">
                                <div class="input-field">
                                    <input type="text" name="nombre" placeholder="Nombre" value="<c:out value="${usuario.nombre}"></c:out>">
                                </div>
                            </div>
                            <div class="col s12">
                                <div class="input-field">

                                    <input type='text' name='sexo' placeholder="Sexo" value="<c:out value="${usuario.sexo}"></c:out>"><br>
                                </div>
                            </div>
                            ...
                            <div class="col s12">
                                <div class="input-field">
                                    ...
                                    <input type="text" name="edad" placeholder="Edad" required onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<c:out value="${usuario.edad}"></c:out>"><br>
