        ...
        <div class="containerForm">
            <div class="row card hoverable">
                <div class="card-content ">
                    <h4 class="center blue-text">Iniciar sesion</h4>
                    <form class="row s12" action="ProductoServletController?action=actualizar" method="post">
                        <input type='hidden' name='id' value="<c:out value="${producto.id}"></c:out>" ><br>  
                        <div class="col s12">
                            <div class="input-field">
                                <input type="text" name="nombreproducto" placeholder="Nombre de producto" value="<c:out value="${producto.nombreproducto}" ></c:out>">
                            </div>
                        </div>
                        <div class="col s12">
                            <div class="input-field">
                                <input type="text" name="descripcion" placeholder="Descripcion" value="<c:out value="${producto.descripcion}"></c:out>">
                            </div>
                        </div>
                        <div class="col s12">
                            <div class="input-field">
                                <input type="text" name="preciounidad" placeholder="Precio unidad" required onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<c:out value="${producto.preciounidad}"></c:out>">
                            </div>
                        </div>
                        ...
                        <div class="col s12">
                            <div class="input-field">
                                ...
                                <input type="text" name="stock" placeholder="Stock" required onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<c:out value="${producto.stock}"></c:out>"><br>
