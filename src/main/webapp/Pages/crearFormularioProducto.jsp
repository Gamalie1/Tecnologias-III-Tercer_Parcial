<%-- 
 ...
 Fecha de modificacion: 22 de mayo de 2022
        ...
        <div class="containerForm">
            <div class="row card hoverable">
                <div class="card-content ">
                    <h4 class="center red-text">Registrar producto</h4>
                    <form class="row s12" action="ProductoServletController?action=crearBD" method="post" class="validate" required>
                        <input type='hidden' name='id' ><br>  
                        <div class="col s12">
                            <div class="input-field">
                                <input type="text" name="nombre" placeholder="Nombre de producto*" class="validate" required>
                            </div>
                        </div>
                        <div class="col s12">
                            <div class="input-field">
                                <input type="text" name="descripcion" placeholder="Descripcion*" class="validate" required>
                            </div>
                        </div>
                        <div class="col s12">
                            <div class="input-field">
                                <input type="text" name="precio" placeholder="Precio del producto" class="validate" required onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                            </div>
                        </div>
                        ...
                        <div class="col s12">
                            <div class="input-field">
                                ...
                                <input type="text" name="stok" placeholder="Cantidad" required onkeypress="return event.charCode >= 48 && event.charCode <= 57" ><br>
                        ...
                        <div class="col s12 center">
                            <button type="submit" class="btn btn-large waves-effect waves-light red" value='Guardar'>Registrarse<i class="material-icons right">send</i></button>
