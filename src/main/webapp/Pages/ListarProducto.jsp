   ...
   <script src="https://kit.fontawesome.com/4c08261d94.js" crossorigin="anonymous"></script>
    ...
    <body>
        ...
        <div class="row indigo lighten-5 z-depth-4">
			...
			<div class="col s12">
				<h4 class="center">
					<b class="teal-text"><em>Listar productos</em></b>
				</h4>
            ...
            <tbody>
                <c:forEach var="producto" items="${ListaProducto}">
                    <tr>
                        ...
                        <td><c:out value="${producto.preciounidad}"/></td>
                        <td><c:out value="${producto.stock}"/></td>
                       
                        
                        <td>
                                    <a class="tooltip_left btn-floating btn-large waves-effect cyan darken-2" href="ProductoServletController?action=actualizarForm&id=<c:out value="${producto.id}"/>">
                                        <i class="fa-solid fa-pen"></i>
                                    </a>
                                    <a class="tooltip_right btn-floating btn-large waves-effect cyan darken-2" href="ProductoServletController?action=eliminar&id=<c:out value="${producto.id}"/>">
